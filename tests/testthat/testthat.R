...
#   TTO_countrylist=c("Brazil","Canada","Chile","Denmark","France","Germany","Italy","Japan","Korea",
...
test_that("Crosswalk EQ5D5L to 3L values", {
  ...
  for (i in 1:1){
    debug(eq5dmap5Lto3LIndscores)
    the.result<-eq5dmap5Lto3LIndscores("UK","CW",answers$X5L.profile[correct_ones[i]])
