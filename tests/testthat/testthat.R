...
test_that("EQ5D5L scoring ", {
  ...
  expect_error(valueEQ5D5LIndscores("England",c(1,1,1), NA, NA, NA, NA),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",c(8,1,1,2,1), NA, NA, NA, NA),"Responses not valid for EQ-5D-5L scores",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",c(3,4,5,6,7,8)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",c(-1,1,1,1,1)),"Responses not valid for EQ-5D-5L scores",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",-1,1,1,1,1),"The responses are not valid",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("US",1,1,1,1,1),"No tariffs found for the country you specified for EQ-5D-5L. Please try later",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("England",345678),"Responses not valid for EQ-5D-5L scores",fixed=TRUE)
  expect_error(valueEQ5D5LIndscores("NM",-11111),"No tariffs found for the country you specified for EQ-5D-5L. Please try later",fixed=TRUE)
})
# # # #################################################################################################################
...
test_that("test for value3L", {
  ...
  expect_error(valueEQ5D3LIndscores("UK","TTO",345678),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("NM","TTO",-11111),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",55555),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(8,1,1,2,1)),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(5,5,5,5,5)),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(3,4,5,6,7,8)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",c(-1,1,1,1,1)),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",-1,1,1,1,1),"The responses are not valid",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("DE","TTO",1,1,1,1,1),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",4,5,6,5,8),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","TTO",-1,2,3,2,2),"The responses are not valid",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("JP","TTO",c(1,2,3,2,3)),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
...
test_that("test for value3L", {
  ...
  expect_error(valueEQ5D3LIndscores("UK","VAS",345678),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("NM","VAS",-11111),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",55555),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(1,1,1), NA, NA, NA, NA),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(8,1,1,2,1), NA, NA, NA, NA),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(5,5,5,5,5)),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(3,4,5,6,7,8)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",c(-1,1,1,1,1)),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",-1,1,1,1,1),"The responses are not valid",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("DE","VAS",1,1,1,1,1),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",4,5,6,5,8),"Responses not valid for EQ-5D-3L scores",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("UK","VAS",-1,2,3,2,2),"The responses are not valid",fixed=TRUE)
  expect_error(valueEQ5D3LIndscores("JP","VAS",c(1,2,3,2,3)),"No country tariffs found for the country you specified for EQ-5D-3L. Please try later",fixed=TRUE)
